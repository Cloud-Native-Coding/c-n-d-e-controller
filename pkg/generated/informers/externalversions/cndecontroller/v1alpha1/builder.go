	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CndecontrollerV1alpha1().Builders(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CndecontrollerV1alpha1().Builders(namespace).Watch(options)
			},
		},
		&cndecontrollerv1alpha1.Builder{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *builderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cndecontrollerv1alpha1.Builder{}, f.defaultInformer)
}
