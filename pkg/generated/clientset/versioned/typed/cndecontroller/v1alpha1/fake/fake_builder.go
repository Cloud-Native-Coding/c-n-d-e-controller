...
var buildersResource = schema.GroupVersionResource{Group: "cndecontroller.k8s.io", Version: "v1alpha1", Resource: "builders"}

var buildersKind = schema.GroupVersionKind{Group: "cndecontroller.k8s.io", Version: "v1alpha1", Kind: "Builder"}
